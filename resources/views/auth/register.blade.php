...
<head>
    ...
    <style>
        ...
        .image-side {
            flex: 1;
            background-image: url('images/register_photo.jpg');
    ...
    <div class="main-container">
        ...
        <div class="form-side">
            <div class="form-container">
                ...
                <h4>Створіть свій акаунт тут</h4>
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group" style="display: flex; align-items: center;">
                        <div class="main-checkbox" style="margin-right: 10px;">
                            <input value="None" id="checkbox1" name="check" type="checkbox" required>
                            <label for="checkbox1"></label>
                        </div>
                        <span class="text" style="color:#994D31;">Я погоджуюся з політикою конфіденційності.</span>
                    </div>
                </form>
